...
const customFile = document.getElementById('customfilebutton'); // Ensure this element ID exists in your HTML
const fileName = document.getElementById('filename'); // Add an element to display file name
